export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-900/50 to-gray-950 overflow-hidden relative">
      ...
      <div className="relative z-10 flex flex-col justify-center min-h-screen p-8 md:p-12 lg:p-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-12 group">
            ...
            <h1 className="relative text-5xl md:text-7xl lg:text-8xl font-black bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-2xl tracking-tight leading-tight">
              Welcome to
              <br />
