        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="relative mb-12 group">
            ...
            <h1 className="relative text-5xl md:text-7xl lg:text-8xl font-black bg-linear-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent drop-shadow-2xl tracking-tight leading-tight">
              Welcome to
              <br />
              <span className="bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 bg-clip-text">
                Unibuddy
              </span>
            </h1>
          </div>
          ...
          <SignedOut>
            <div className="max-w-3xl mx-auto mb-16 grid gap-4">
              ...
              <SignInButton mode="redirect">
                <div className="relative group cursor-pointer">
                  <div className="absolute inset-0 bg-gradient-to-r from-slate-800/50 to-gray-800/50 backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl shadow-slate-900/50 transform group-hover:scale-[1.02] transition-all duration-500 overflow-hidden"></div>
                  <div className="relative w-full py-5 px-8">
                    <p className="text-base md:text-lg font-semibold text-gray-200 group-hover:text-white transition-colors duration-300">
